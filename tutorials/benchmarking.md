...
MethodInstance for Main.var\"workspace#4\".double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.var\"workspace#4\" at /home/runner/work/trial/trial/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 990 evaluations.
 Range (min … max):   47.172 ns … 25.027 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      50.304 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   141.869 ns ±  1.092 μs  ┊ GC (mean ± σ):  1.12% ± 1.39%

     ▁▃▇█                                                       
  ▂▃▅█████▅▄▃▃▃▃▂▂▂▂▂▃▃▃▃▃▇██▆▄▄▃▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▁▁▂▂▁▁▁▂ ▃
  47.2 ns         Histogram: frequency by time         73.4 ns <
...
BenchmarkTools.Trial: 10000 samples with 996 evaluations.
 Range (min … max):  24.799 ns …  28.169 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     27.210 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   75.204 ns ± 748.008 ns  ┊ GC (mean ± σ):  3.51% ± 1.41%

   ▃▄▂▅▅█▆█▇▄▂    ▂▁▁▁         ▁▁  ▁▂▃▅▅▄▄▄▃▂▂                 ▂
  ▅████████████████████▇▇▆▃▅▆████▇▇████████████▇█▇▆▆▆▅▅▄▆▂▅▅▇▆ █
  24.8 ns       Histogram: log(frequency) by time      41.2 ns <
